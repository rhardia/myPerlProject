...
#	$grpCode =~ s/\A[[:^print:]\s]|[[:^print:]\s]\z/;
	...
	$dbkey = $GMIExCode."!".$account."!".$combineCode."!".$grpCode."!".$actype;
	...
	while( my( $key, $value ) = each %mgResults ){
		if(exists $mgResults1{$key}){
			...
			if (($diffMM>10)||($diffIM>10)){
				print WRITECSV "$arrKey[0],$arrKey[1],$arrKey[2],$arrKey[4],$arrResults[0],$arrResults[6],$arrResults[1],$arrResults[2],$arrResults[3],$arrResults[4],$arrResults[5],$arrResults1[0],$arrResults1[6],$arrResults1[1],$arrResults1[2],$arrResults1[3],$arrResults1[4],$arrResults1[5],$diffMM,$diffIM,$diffNOV,$diffSOM \n";
			}
			else{
				print WRITECSVALL "$arrKey[0],$arrKey[1],$arrKey[2],$arrKey[4],$arrResults[0],$arrResults[6],$arrResults[1],$arrResults[2],$arrResults[3],$arrResults[4],$arrResults[5],$arrResults1[0],$arrResults1[6],$arrResults1[1],$arrResults1[2],$arrResults1[3],$arrResults1[4],$arrResults1[5],$diffMM,$diffIM,$diffNOV,$diffSOM \n";
			}
