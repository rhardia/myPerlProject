...
print WRITECSV "SPAN Method Code,Account,Combine Comm Code,Currency,SPAN Maint Margin,SPAN NOV,GMS Maint Margin,GMS NOV,Diff Maint Margin,Diff NOV \n";
print WRITECSVALL "SPAN Method Code,Account,Combine Comm Code,Currency,SPAN Maint Margin,SPAN NOV,GMS Maint Margin,GMS NOV,Diff Maint Margin,Diff NOV \n";
...
#	$COMB_EXCH =~ s/^\s+|\s+$//g;
	...
	if(exists $mgResults{$SPANKey}){
			...
			if ($diffMaint>10){
				print WRITECSV "$METHOD,$ACCODE,$COMB_CODE,$CURRCODE,$COMB_MAINT,$NOV,$arrResults[0],$arrResults[1],$diffMaint,$diffNOV \n";
			}
			else{
				print WRITECSVALL "$METHOD,$ACCODE,$COMB_CODE,$CURRCODE,$COMB_MAINT,$NOV,$arrResults[0],$arrResults[1],$diffMaint,$diffNOV \n";
			}
